    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="bg-white rounded-lg shadow-xl p-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">Excel to PDF</h1>
          <p className="text-gray-600 mb-2">Convert Excel spreadsheets to PDF</p>
          <p className="text-gray-500 mb-8">This free Excel to PDF converter transforms XLS and XLSX files into professional PDF documents. Preserve all formatting and data in an easy-to-share PDF format.</p>

          <div className="mb-8">
            <label className="block text-lg font-semibold text-gray-700 mb-4">Select an Excel File</label>
            <div className="border-2 border-dashed border-indigo-300 rounded-lg p-8 text-center hover:border-indigo-500 transition-colors">
              ...
              <label htmlFor="file-input" className="cursor-pointer">
                ...
                <p className="text-sm text-gray-500">Supported: XLS, XLSX</p>
              </label>
            </div>
          </div>
