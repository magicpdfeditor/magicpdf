    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="bg-white rounded-lg shadow-xl p-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">Unlock PDF</h1>
          <p className="text-gray-600 mb-8">Remove passwords and restrictions from PDFs</p>
          ...
          <div className="mb-8">
            <label className="block text-lg font-semibold text-gray-700 mb-4">Password (if applicable)</label>
            <input
              type="password"
              value={password}
          ...
          >
            {uploading ? 'Unlocking...' : 'Unlock PDF'}
          </button>
        </div>
      </div>
