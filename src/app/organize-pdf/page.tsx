...
export default function OrganizePdfPage() {
  ...
  const handleOrganize = async () => {
    if (files.length === 0) {
      setError('Please select PDF files to organize');
      return;
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="bg-white rounded-lg shadow-xl p-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">Organize PDF</h1>
          <p className="text-gray-600 mb-8">Organize and merge multiple PDF files</p>

          <div className="mb-8">
            <label className="block text-lg font-semibold text-gray-700 mb-4">Select PDF Files</label>
            <div className="border-2 border-dashed border-indigo-300 rounded-lg p-8 text-center hover:border-indigo-500 transition-colors">
              ...
              <label htmlFor="file-input" className="cursor-pointer">
                ...
                <p className="text-lg text-gray-600">Click to select files</p>
              </label>
            </div>
          </div>
          ...
          >
            {uploading ? 'Organizing...' : 'Organize PDFs'}
          </button>
        </div>
      </div>
      {/* Footer */}
