    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="bg-white rounded-lg shadow-xl p-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">Edit PDF</h1>
          <p className="text-gray-600 mb-2">Edit text and content in PDFs</p>
          <p className="text-gray-500 mb-8">This free PDF editor allows you to edit text and content directly in your PDF files. Add, remove, or modify text without needing expensive software.</p>
