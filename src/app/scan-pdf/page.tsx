...
export default function ScanPdfPage() {
  ...
  const handleScan = async () => {
    ...
    try {
      ...
      setError('Error processing scanned document. Please try again.');
      console.error(err);
    } finally {
      setUploading(false);
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="bg-white rounded-lg shadow-xl p-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">Scan PDF</h1>
          <p className="text-gray-600 mb-2">Enhance and optimize scanned documents</p>
          <p className="text-gray-500 mb-8">This free PDF scanner tool enhances and optimizes scanned documents. Improve clarity, contrast, and readability of your scanned PDFs.</p>

          <div className="mb-8">
            <label className="block text-lg font-semibold text-gray-700 mb-4">Select a Scanned Image or PDF</label>
          ...
          >
            {uploading ? 'Processing...' : 'Enhance Scan'}
          </button>
        </div>
      </div>
      {/* Footer */}
