...
export default function PdfToPdfAPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      setError('Error converting to PDF/A. Please try again.');
      console.error(err);
    } finally {
      setUploading(false);
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="bg-white rounded-lg shadow-xl p-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">PDF to PDF/A</h1>
          <p className="text-gray-600 mb-8">Convert PDF to archival PDF/A format for long-term preservation</p>
          ...
          >
            {uploading ? 'Converting...' : 'Convert to PDF/A'}
          </button>
        </div>
      </div>
