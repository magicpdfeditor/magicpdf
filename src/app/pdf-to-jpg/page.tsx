    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="bg-white rounded-lg shadow-xl p-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">PDF to JPG</h1>
          <p className="text-gray-600 mb-2">Convert PDF pages to JPEG images</p>
          <p className="text-gray-500 mb-8">This free PDF to JPG converter lets you extract individual pages from your PDF as high-quality JPEG images. Perfect for sharing specific pages or creating image galleries.</p>
          ...
          >
            {uploading ? 'Converting...' : 'Convert to JPG'}
          </button>
        </div>
      </div>
