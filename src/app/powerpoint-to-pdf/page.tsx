    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="bg-white rounded-lg shadow-xl p-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">PowerPoint to PDF</h1>
          <p className="text-gray-600 mb-2">Convert PowerPoint presentations to PDF format</p>
          <p className="text-gray-500 mb-8">This free PowerPoint to PDF converter allows you to quickly convert PPT files into high-quality PDFs online. Perfect for sharing presentations or creating printable documents.</p>

          <div className="mb-8">
            <label className="block text-lg font-semibold text-gray-700 mb-4">Select a PowerPoint File</label>
            <div className="border-2 border-dashed border-indigo-300 rounded-lg p-8 text-center hover:border-indigo-500 transition-colors">
              ...
              <label htmlFor="file-input" className="cursor-pointer">
                ...
                <p className="text-sm text-gray-500">Supported: PPT, PPTX</p>
              </label>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-8 border-t border-gray-800 mt-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p>&copy; 2026 PDF Magic. All rights reserved. Made with ❤️</p>
